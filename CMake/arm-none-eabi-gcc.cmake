#
# arm-none-eabi-gcc 交叉编译器，添加到环境变量 windows下
# 下载链接https://armkeil.blob.core.windows.net/developer/Files/downloads/gnu-rm/10.3-2021.10/gcc-arm-none-eabi-10.3-2021.10-win32.zip
#
...
# "E:/SDK-Win/gcc-arm-none-eabi-10.3-2021.10/bin/arm-none-eabi-")
...
add_link_options(
  # 指定链接时使用的连接脚本
  -T${PROJECT_SOURCE_DIR}/gd32f4xx_flash.ld
  -mcpu=cortex-m4
  # 指定生成 Thumb 指令集的代码
  -mthumb
  # 指定浮点单元的类型。fpv4-sp-d16 表示使用单精度浮点单元
  ...
  # 指定浮点运算的 ABI（Application Binary Interface）。hard 表示浮点运算将使用硬件浮点寄存器
  -mfloat-abi=hard
  # 使用 Newlib Nano 库，这是一个更小、更适合嵌入式系统的 C 库，可以减小生成的代码大小并提高执行效率 --specs=nano.specs
  --specs=nosys.specs
  # 将 printf 函数与浮点数支持链接
  -u_printf_float
  # 于强制链接静态库，适用于裸机
