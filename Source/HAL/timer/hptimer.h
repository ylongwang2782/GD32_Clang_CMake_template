...
/**
 * @file hptimer.h
 * @brief High Precision Timer - C Interface
 * 
 * This header provides a C-compatible interface for the high precision timer.
 * Use this header in C files, or use hal_hptimer.hpp in C++ files.
 */
